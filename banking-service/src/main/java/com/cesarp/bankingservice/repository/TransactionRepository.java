package com.cesarp.bankingservice.repository;
...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT t.transactionDate, COUNT(t) FROM Transaction t WHERE t.transactionDate BETWEEN :startDate AND :endDate " +
            "AND (t.sourceAccount.accountNumber=:accountNumber OR t.targetAccount.accountNumber=:accountNumber) GROUP BY t.transactionDate")
